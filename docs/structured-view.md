...
| `gemini` | `gemini --acp` (native) | `npm install -g @google/gemini-cli` | `GEMINI_API_KEY`, OAuth, or Vertex. Deprecated upstream since 2026-06-18: consumer accounts cut off by Google; enterprise/API-key remain valid |
