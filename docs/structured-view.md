...
| `gemini` | `gemini --acp` (native) | `npm install -g @google/gemini-cli` | `GEMINI_API_KEY`, OAuth, or Vertex. Deprecated upstream for individual accounts since 2026-06-18; enterprise and API-key auth keep working |
