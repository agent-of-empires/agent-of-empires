...
older tmux, a split window, or a non-Unix host falls back to the polling
path automatically; everything still works, just with more latency. The
paired host and container shells always use the polling path.
