...
/** Lower half of the agent section: workflow preset, sandbox / auto-approve
 *  toggles, and the advanced launch knobs. Split out of the old monolithic
 *  AgentStep (#2210) so the single-screen wizard can fold it behind More
 *  options while the picker + structured-view choice stay up top. */
