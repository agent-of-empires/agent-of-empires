...
//! blocks in a toggleable overlay (#2467). Icons, tooltips, hrefs, and the
//! `Card`/`RowBadge`/`RowColumn`/`SortKey`/`FilterFacet` slots have no TUI
//! surface here and are ignored.
//!
