...
//! and `Pane` / `HomePane` blocks in a toggleable overlay (#2467). Icons,
//! tooltips, hrefs and the `Card`/`RowBadge`/`SortKey`/`FilterFacet` slots have
//! no TUI surface, and neither does `RowColumn` (#2948) since the remote-home
//! screen it was written for became rows in the home list.
//!
