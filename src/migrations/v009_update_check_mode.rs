...
mod tests {
    ...
    #[test]
    fn update_check_mode_cases() {
        // check enabled false maps to off
        {
            let (_dir, path) = write(
                r#"
    [updates]
    ...
    "#,
        ...
        // check enabled true maps to notify
        {
            let (_dir, path) = write(
                r#"
    [updates]
    ...
    "#,
        ...
        // already migrated is idempotent
        {
            let (_dir, path) = write(
                r#"
    [updates]
    ...
    "#,
        ...
        // existing mode wins over legacy check enabled
        {
            let (_dir, path) = write(
                r#"
    [updates]
