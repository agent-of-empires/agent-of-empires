...
mod tests {
    ...
    #[test]
    fn prune_tuning_settings_cases() {
        ...
        // dropped keys are removed and others kept
        {
            let result = migrated(
                r#"
    [session]
    ...
    "#,
        ...
        // session id poller max threads survives migration
        {
    ...
    "#,
        ...
        // config with only poller threads is untouched
        {
            let (_dir, path) = write(
                r#"
    [session]
