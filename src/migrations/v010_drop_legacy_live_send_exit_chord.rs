...
mod tests {
    ...
    #[test]
    fn drop_legacy_live_send_exit_chord_cases() {
        // shipped 1 9 0 default is dropped
        {
            let (_dir, path) = write(
                r#"
    [session]
    ...
    "#,
        ...
        // in dev backslash default is dropped
        {
            let (_dir, path) = write(
                r#"
    [session]
    ...
    "#,
        ...
        // long form modifier names are recognized
        {
            let (_dir, path) = write(
                r#"
    [session]
    ...
    "#,
        ...
        // customized chord list is left alone
        {
    ...
    "#,
        ...
        // current default value is left alone
        {
    ...
    "#,
        ...
        // unrelated custom value is left alone
        {
